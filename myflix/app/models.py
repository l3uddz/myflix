...
class Profile(models.Model):
    ...
    server = models.OneToOneField(PlexServer, null=True, verbose_name="Server this user is subscribed too")
    tier = models.OneToOneField(PlexTier, null=True, verbose_name="Tier this user is subscribed too")
